...
namespace EditorWindows
{
    ...
    public partial class SideRhythmicStructuresWindow
    {
        ...
        public SideRhythmicStructuresWindow() {
            ...
            this.Show();
            EditorSettings.Singleton.SidePanels.PanelOpen("SideRhythmicStructures");
            //// this.Localize();
        }
        #endregion
        ...
        private void Window_Closing(object sender, System.ComponentModel.CancelEventArgs e) {
            ...
            EditorSettings.Singleton.SidePanels.PanelClose("SideHarmony");
        }
        ...
        private void RhythmicPlan(object sender, System.Windows.RoutedEventArgs e) {
            ...
            if (SideRhythmWindow.Singleton != null) {
