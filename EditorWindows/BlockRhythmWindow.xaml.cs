// <copyright file="BlockRhythmWindow.xaml.cs" company="Traced-Ideas, Czech republic">
...
namespace EditorWindows
{
    ...
    /// Detail Window.
    /// </summary>
    public partial class BlockRhythmWindow
    {
        #region Fields
        /// <summary>
        /// Singleton variable.
        /// </summary>
        private static BlockRhythmWindow singleton;

        #endregion

        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockRhythmWindow"/> class.
        /// </summary>
        public BlockRhythmWindow()
        {
            Singleton = this;
        ...
        public static BlockRhythmWindow Singleton
        {
            get
            {
                Contract.Ensures(Contract.Result<BlockRhythmWindow>() != null);
                return singleton;
            }
        ...
        private void DropImage(object sender, DragEventArgs e) {
            ...
            if (exists) {
                if (e.Data.GetData("MusicalBlock") is MusicalBlock musicalBlock) {
                    ...
                    this.PanelDetailMaterial.LoadData(rhythmicModel);
