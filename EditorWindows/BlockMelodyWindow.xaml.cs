// <copyright file="BlockMelodyWindow.xaml.cs" company="Traced-Ideas, Czech republic">
...
namespace EditorWindows
{
    ...
    /// Detail Window.
    /// </summary>
    public partial class BlockMelodyWindow
    {
        #region Fields
        /// <summary>
        /// Singleton variable.
        /// </summary>
        private static BlockMelodyWindow singleton;

        #endregion

        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockMelodyWindow"/> class.
        /// </summary>
        public BlockMelodyWindow()
        {
            Singleton = this;
        ...
        /// <summary>
        /// Gets the BlockMelodyWindow Singleton.
        /// </summary>
        /// <value> Property description. </value>
        public static BlockMelodyWindow Singleton
        {
            get
            {
                Contract.Ensures(Contract.Result<BlockMelodyWindow>() != null);
                return singleton;
            }
        ...
        private void DropImage(object sender, DragEventArgs e) {
            ...
            if (exists) {
                if (e.Data.GetData("MusicalBlock") is MusicalBlock musicalBlock) {
                    ...
                    this.PanelDetailMaterial.LoadData(melodicModel);
