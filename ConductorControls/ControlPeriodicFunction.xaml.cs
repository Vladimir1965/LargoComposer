...
namespace ConductorControls
{
    ...
    public partial class ControlPeriodicFunction 
    {
        ...
        public int Period {
            get {
                return (int)this.sliderPeriod.Value;
            }

            set {
                this.sliderPeriod.Value = value;
            }
        }
        ...
        public int Phase {
            get {
                return (int)this.sliderPhase.Value;
            }

            set {
                this.sliderPhase.Value = value;
            }
        }
        ...
        /// The function.
        /// </value>
        public PeriodicFunction Function {
            get {
                return (PeriodicFunction)this.comboFunction.SelectedIndex;
            }

            set {
                this.comboFunction.SelectedIndex = (int)value;
            }
        }
        ...
        public int Base {
            get {
                return (int)this.sliderBase.Value;
            }

            set {
                this.sliderBase.Value = value;
            }
        }
