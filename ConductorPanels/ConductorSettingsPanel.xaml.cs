// <copyright file="ConductorSettingsPanel.xaml.cs" company="Traced-Ideas, Czech republic">
...
namespace ConductorPanels
{
    ...
    /// Panel Composition.
    /// </summary>
    public partial class ConductorSettingsPanel
    {
        /*// <summary>
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="ConductorSettingsPanel"/> class.
        /// </summary>
        public ConductorSettingsPanel() {
        ...
        public override void LoadData() {
            ...
            ConductorSettings.Singleton.Load();
            this.SetValues();
        ...
        private void SaveChanges(object sender, RoutedEventArgs e) {
            var settings = ConductorSettings.Singleton;
